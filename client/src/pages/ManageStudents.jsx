        ...
        <main className='w-9/12 h-full'>
            ...
            <form className="max-w-[266px]">   
                ...
                <div className="relative">
                    ...
                    <input onChange={(e)=>dispatch(getAllStudents(e.target.value))} type="search" id="default-search" className="border block w-full ps-10 pe-3 py-3 text-sm  border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500  dark:placeholder-gray-400 text-black" placeholder="Search by names" required />
